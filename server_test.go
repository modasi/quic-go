...
func newMockSession(_ connection, _ protocol.VersionNumber, connectionID protocol.ConnectionID, _ *handshake.ServerConfig, _ closeCallback, _ cryptoChangeCallback, _ []protocol.VersionNumber) (packetHandler, error) {
	return &mockSession{
